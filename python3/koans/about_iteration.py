...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        #
        # reduce applies the passed function on passed sequence
        # from left to right example: applies self.add on 2 and 3
        # then on result of add(2,3) and 4 ... so on third arg is used as
        # first value for first function call and default if sequence is empty
